...
可以通过创建一个带有`@Configuration`注解的类并继承`WebMvcConfigurer`接口来扩展 Spring MVC 的配置。`WebMvcConfigurer`接口包含许多方法，可以用来定制 Spring MVC 的行为。
...
> 原文: <https://www.yuque.com/jingdianjichi/xyxdsi/skw13rkoq4ls7zzx>